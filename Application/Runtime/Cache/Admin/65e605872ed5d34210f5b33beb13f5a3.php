...
<div class="container" style="width: 980px;padding: 0">
    <div class="panel panel-info">
        <div class="panel-heading" style="height: 60px">
            <span class="pull-left" style="text-align: center;align-content: center;font-size: 16px">修改密码</span>
            <a type="button" class="btn btn-danger pull-right" href="/zhaoping/index.php/Admin/Login/login">退出</a>
        </div>
        <form class="form-horizontal" name="modifyForm" method="post" action="/zhaoping/index.php/Admin/User/modifyPsd" role="form" onsubmit="return checkForm();">
