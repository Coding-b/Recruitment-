...
<div class="container" style="width: 980px;padding: 0">
    <div class="panel panel-info">
        ...
        <div class="panel-footer">
            <a type="button" class="btn btn-success" href="/zhaoping/index.php/Department/Verify/dealFirstInfo?id=<?php echo ($information["FC_id"]); ?>&type=1">通&nbsp;&nbsp;&nbsp;&nbsp;过</a>
    ...
    <div class="modal fade" id="notModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form" role="form" action="/zhaoping/index.php/Department/Verify/dealFirstInfo" method="get">
